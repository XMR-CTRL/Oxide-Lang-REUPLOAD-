...
; preserves dispatch_mut <= ept_aligned_at  (source line 53)
(declare-const preserves_dispatch_mut_ept_aligned_at_arg_0 Int)
(declare-const preserves_dispatch_mut_ept_aligned_at_arg_1 Int)
(declare-const preserves_dispatch_mut_ept_aligned_at_arg_2 (Array Int Int))
(declare-const preserves_dispatch_mut_ept_aligned_at_call_result_0 Int)
; preserves_dispatch_mut_ept_aligned_at_call_requires_1_0 (call requires, source line 0)
(define-fun preserves_dispatch_mut_ept_aligned_at_call_requires_1_0 () Bool (and (<= 0 preserves_dispatch_mut_ept_aligned_at_arg_0) (< preserves_dispatch_mut_ept_aligned_at_arg_0 4)))

; --- discharge (preserves_dispatch_mut_ept_aligned_at_call_requires_1_0) ---
(push)
(assert (not preserves_dispatch_mut_ept_aligned_at_call_requires_1_0))
(check-sat)
(pop)

; preserves_dispatch_mut_ept_aligned_at_call_requires_2_1 (call requires, source line 37)
(define-fun preserves_dispatch_mut_ept_aligned_at_call_requires_2_1 () Bool (= (bvand ((_ int2bv 64) preserves_dispatch_mut_ept_aligned_at_arg_1) (_ bv4095 64)) (_ bv0 64)))

; --- discharge (preserves_dispatch_mut_ept_aligned_at_call_requires_2_1) ---
(push)
(assert (not preserves_dispatch_mut_ept_aligned_at_call_requires_2_1))
(check-sat)
(pop)

(define-fun preserves_dispatch_mut_ept_aligned_at_inline_3_req0 () Bool (and (<= 0 preserves_dispatch_mut_ept_aligned_at_arg_0) (< preserves_dispatch_mut_ept_aligned_at_arg_0 4)))
(define-fun preserves_dispatch_mut_ept_aligned_at_inline_3_req1 () Bool (= (bvand ((_ int2bv 64) preserves_dispatch_mut_ept_aligned_at_arg_1) (_ bv4095 64)) (_ bv0 64)))
(declare-const preserves_dispatch_mut_ept_aligned_at_call_result_4 Int)
; preserves_dispatch_mut_ept_aligned_at_call_requires_5_0 (call requires, source line 0)
(define-fun preserves_dispatch_mut_ept_aligned_at_call_requires_5_0 () Bool (and (<= 0 preserves_dispatch_mut_ept_aligned_at_arg_0) (< preserves_dispatch_mut_ept_aligned_at_arg_0 4)))

; --- discharge (preserves_dispatch_mut_ept_aligned_at_call_requires_5_0) ---
(push)
(assert preserves_dispatch_mut_ept_aligned_at_inline_3_req0)
(assert preserves_dispatch_mut_ept_aligned_at_inline_3_req1)
(assert (= preserves_dispatch_mut_ept_aligned_at_arg_0 0))
(assert (not preserves_dispatch_mut_ept_aligned_at_call_requires_5_0))
(check-sat)
(pop)

; preserves_dispatch_mut_ept_aligned_at_call_requires_6_1 (call requires, source line 18)
(define-fun preserves_dispatch_mut_ept_aligned_at_call_requires_6_1 () Bool (= (bvand ((_ int2bv 64) preserves_dispatch_mut_ept_aligned_at_arg_1) (_ bv4095 64)) (_ bv0 64)))

; --- discharge (preserves_dispatch_mut_ept_aligned_at_call_requires_6_1) ---
(push)
(assert preserves_dispatch_mut_ept_aligned_at_inline_3_req0)
(assert preserves_dispatch_mut_ept_aligned_at_inline_3_req1)
(assert (= preserves_dispatch_mut_ept_aligned_at_arg_0 0))
(assert (not preserves_dispatch_mut_ept_aligned_at_call_requires_6_1))
(check-sat)
(pop)

(define-fun preserves_dispatch_mut_ept_aligned_at_inline_7_req0 () Bool (and (<= 0 preserves_dispatch_mut_ept_aligned_at_arg_0) (< preserves_dispatch_mut_ept_aligned_at_arg_0 4)))
(define-fun preserves_dispatch_mut_ept_aligned_at_inline_7_req1 () Bool (= (bvand ((_ int2bv 64) preserves_dispatch_mut_ept_aligned_at_arg_1) (_ bv4095 64)) (_ bv0 64)))
(declare-const preserves_dispatch_mut_ept_aligned_at_call_result_8 Int)
; preserves_dispatch_mut_ept_aligned_at_call_requires_9_0 (call requires, source line 0)
(define-fun preserves_dispatch_mut_ept_aligned_at_call_requires_9_0 () Bool (and (<= 0 preserves_dispatch_mut_ept_aligned_at_arg_0) (< preserves_dispatch_mut_ept_aligned_at_arg_0 4)))

; --- discharge (preserves_dispatch_mut_ept_aligned_at_call_requires_9_0) ---
(push)
(assert preserves_dispatch_mut_ept_aligned_at_inline_3_req0)
(assert preserves_dispatch_mut_ept_aligned_at_inline_3_req1)
(assert (not preserves_dispatch_mut_ept_aligned_at_call_requires_9_0))
(check-sat)
(pop)

(define-fun preserves_dispatch_mut_ept_aligned_at_inline_10_req0 () Bool (and (<= 0 preserves_dispatch_mut_ept_aligned_at_arg_0) (< preserves_dispatch_mut_ept_aligned_at_arg_0 4)))
; preservation obligation: forall args, reqHandler ==> I(args, result)
;   reqHandler = conjunction of handler's requires clauses
;   I(args, result) = invariant spec fn body, with `result` bound to
;     the #2 WP mini-walker's inlined body terminal term
;     (NOT a fresh const + assumed ensures — soundness-critical)
(push)
(assert (not (forall ((preserves_dispatch_mut_ept_aligned_at_arg_0 Int) (preserves_dispatch_mut_ept_aligned_at_arg_1 Int) (preserves_dispatch_mut_ept_aligned_at_arg_2 (Array Int Int))) (=> (and (and (<= 0 preserves_dispatch_mut_ept_aligned_at_arg_0) (< preserves_dispatch_mut_ept_aligned_at_arg_0 4)) (= (bvand ((_ int2bv 64) preserves_dispatch_mut_ept_aligned_at_arg_1) (_ bv4095 64)) (_ bv0 64))) (= (bvand ((_ int2bv 64) (select preserves_dispatch_mut_ept_aligned_at_arg_2 preserves_dispatch_mut_ept_aligned_at_arg_0)) (_ bv4095 64)) (_ bv0 64))))))
(check-sat)
(pop)
; note: preserves discharge — unsat => handler preserves invariant
