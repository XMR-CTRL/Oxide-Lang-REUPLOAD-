...
; --- discharge (noninterference_vcpu_a_map_vs_vcpu_b_map_call_requires_1_0) ---
(push)
(assert (not noninterference_vcpu_a_map_vs_vcpu_b_map_call_requires_1_0))
(check-sat-using (then simplify smt))
(check-sat-using (then simplify (using-params smt :mbqi true)))
(check-sat-using (then simplify (using-params smt :mbqi false) (using-params smt :restart-strategy 0)))
(pop)

; noninterference_vcpu_a_map_vs_vcpu_b_map_call_requires_2_1 (call requires, source line 0)
(define-fun noninterference_vcpu_a_map_vs_vcpu_b_map_call_requires_2_1 () Bool (or (= noninterference_vcpu_a_map_vs_vcpu_b_map_arg_1 0) (= (mod noninterference_vcpu_a_map_vs_vcpu_b_map_arg_1 4096) 0)))

; --- discharge (noninterference_vcpu_a_map_vs_vcpu_b_map_call_requires_2_1) ---
(push)
(assert (not noninterference_vcpu_a_map_vs_vcpu_b_map_call_requires_2_1))
(check-sat-using (then simplify smt))
(check-sat-using (then simplify (using-params smt :mbqi true)))
(check-sat-using (then simplify (using-params smt :mbqi false) (using-params smt :restart-strategy 0)))
(pop)

; stability obligation: forall shared_args,
;   req_hA(shared) ∧ I(shared) ==> I(shared_post)
;   I_pre  = (and (or (= noninterference_vcpu_a_map_vs_vcpu_b_map_arg_0 0) (= (mod noninterference_vcpu_a_map_vs_vcpu_b_map_arg_0 4096) 0)) (or (= noninterference_vcpu_a_map_vs_vcpu_b_map_arg_1 0) (= (mod noninterference_vcpu_a_map_vs_vcpu_b_map_arg_1 4096) 0)))
;   I_post = (and (or (= noninterference_vcpu_a_map_vs_vcpu_b_map_arg_0 0) (= (mod noninterference_vcpu_a_map_vs_vcpu_b_map_arg_0 4096) 0)) (or (= noninterference_vcpu_a_map_vs_vcpu_b_map_arg_1 0) (= (mod noninterference_vcpu_a_map_vs_vcpu_b_map_arg_1 4096) 0)))
(push)
; note: I_pre == I_post — trivially stable (no mutation detected)
(assert (not (forall ( (noninterference_vcpu_a_map_vs_vcpu_b_map_arg_0 Int) (noninterference_vcpu_a_map_vs_vcpu_b_map_arg_1 Int)) (=> (and (= (mod noninterference_vcpu_a_map_vs_vcpu_b_map_arg_0 4096) 0) (or (= noninterference_vcpu_a_map_vs_vcpu_b_map_arg_1 0) (= (mod noninterference_vcpu_a_map_vs_vcpu_b_map_arg_1 4096) 0))) (and (or (= noninterference_vcpu_a_map_vs_vcpu_b_map_arg_0 0) (= (mod noninterference_vcpu_a_map_vs_vcpu_b_map_arg_0 4096) 0)) (or (= noninterference_vcpu_a_map_vs_vcpu_b_map_arg_1 0) (= (mod noninterference_vcpu_a_map_vs_vcpu_b_map_arg_1 4096) 0)))))))
(check-sat-using (then simplify smt))
(pop)
; note: noninterference discharge — unsat => vcpu_a_map does not interfere with vcpu_b_map


; --- pair: vcpu_b_map step vs vcpu_a_map assertion ---
(declare-const noninterference_vcpu_b_map_vs_vcpu_a_map_arg_0 Int)
(declare-const noninterference_vcpu_b_map_vs_vcpu_a_map_arg_1 Int)
(declare-const noninterference_vcpu_b_map_vs_vcpu_a_map_call_result_0 Int)
; noninterference_vcpu_b_map_vs_vcpu_a_map_call_requires_1_0 (call requires, source line 0)
(define-fun noninterference_vcpu_b_map_vs_vcpu_a_map_call_requires_1_0 () Bool (or (= noninterference_vcpu_b_map_vs_vcpu_a_map_arg_0 0) (= (mod noninterference_vcpu_b_map_vs_vcpu_a_map_arg_0 4096) 0)))

; --- discharge (noninterference_vcpu_b_map_vs_vcpu_a_map_call_requires_1_0) ---
(push)
(assert (not noninterference_vcpu_b_map_vs_vcpu_a_map_call_requires_1_0))
(check-sat-using (then simplify smt))
(check-sat-using (then simplify (using-params smt :mbqi true)))
(check-sat-using (then simplify (using-params smt :mbqi false) (using-params smt :restart-strategy 0)))
(pop)

; noninterference_vcpu_b_map_vs_vcpu_a_map_call_requires_2_1 (call requires, source line 0)
(define-fun noninterference_vcpu_b_map_vs_vcpu_a_map_call_requires_2_1 () Bool (= (mod noninterference_vcpu_b_map_vs_vcpu_a_map_arg_1 4096) 0))

; --- discharge (noninterference_vcpu_b_map_vs_vcpu_a_map_call_requires_2_1) ---
(push)
(assert (not noninterference_vcpu_b_map_vs_vcpu_a_map_call_requires_2_1))
(check-sat-using (then simplify smt))
(check-sat-using (then simplify (using-params smt :mbqi true)))
(check-sat-using (then simplify (using-params smt :mbqi false) (using-params smt :restart-strategy 0)))
(pop)
...
; stability obligation: forall shared_args,
;   req_hA(shared) ∧ I(shared) ==> I(shared_post)
;   I_pre  = (and (or (= noninterference_vcpu_b_map_vs_vcpu_a_map_arg_0 0) (= (mod noninterference_vcpu_b_map_vs_vcpu_a_map_arg_0 4096) 0)) (or (= noninterference_vcpu_b_map_vs_vcpu_a_map_arg_1 0) (= (mod noninterference_vcpu_b_map_vs_vcpu_a_map_arg_1 4096) 0)))
;   I_post = (and (or (= noninterference_vcpu_b_map_vs_vcpu_a_map_arg_0 0) (= (mod noninterference_vcpu_b_map_vs_vcpu_a_map_arg_0 4096) 0)) (or (= noninterference_vcpu_b_map_vs_vcpu_a_map_arg_1 0) (= (mod noninterference_vcpu_b_map_vs_vcpu_a_map_arg_1 4096) 0)))
(push)
; note: I_pre == I_post — trivially stable (no mutation detected)
(assert (not (forall ( (noninterference_vcpu_b_map_vs_vcpu_a_map_arg_0 Int) (noninterference_vcpu_b_map_vs_vcpu_a_map_arg_1 Int)) (=> (and (or (= noninterference_vcpu_b_map_vs_vcpu_a_map_arg_0 0) (= (mod noninterference_vcpu_b_map_vs_vcpu_a_map_arg_0 4096) 0)) (= (mod noninterference_vcpu_b_map_vs_vcpu_a_map_arg_1 4096) 0)) (and (or (= noninterference_vcpu_b_map_vs_vcpu_a_map_arg_0 0) (= (mod noninterference_vcpu_b_map_vs_vcpu_a_map_arg_0 4096) 0)) (or (= noninterference_vcpu_b_map_vs_vcpu_a_map_arg_1 0) (= (mod noninterference_vcpu_b_map_vs_vcpu_a_map_arg_1 4096) 0)))))))
(check-sat-using (then simplify smt))
(pop)
; note: noninterference discharge — unsat => vcpu_b_map does not interfere with vcpu_a_map
